    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-[320px_1fr]">
        <div className="overflow-hidden rounded-lg border border-white/10 bg-surface">
          <div className="border-b border-white/10 bg-white/5 px-4 py-2 text-xs font-semibold uppercase text-slate-400">
            ...
            {queue.map((item) => (
              <li key={item.id}>
                <button
                  ...
                  className={`w-full border-t border-white/10 px-4 py-3 text-left hover:bg-white/5 ${
        ...
        {detail ? (
          <div className="rounded-lg border border-white/10 bg-surface p-5">
                  ...
                  <div key={f}>
                    ...
                    <input
                      className={`mt-1 w-full rounded-md border px-3 py-2 ${
                        low ? "border-red-300 bg-red-50" : "border-white/15"
                      }`}
                      value={form[f] ?? ""}
            ...
            <details className="mt-4">
              <summary className="cursor-pointer text-sm text-slate-400">View OCR text</summary>
              <pre className="mt-2 max-h-48 overflow-auto rounded bg-white/5 p-3 text-xs text-slate-300">
          ...
          <div className="flex items-center justify-center rounded-lg border border-dashed border-white/10 bg-surface p-12 text-sm text-slate-400">
